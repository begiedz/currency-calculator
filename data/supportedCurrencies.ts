export const supportedCurrencies = [
    ...
    { code: "ANG", name: "Netherlands Antillian Guilder", country: "Netherlands Antilles", flag: "🇧🇶" },
    ...
    { code: "BAM", name: "Bosnia and Herzegovina Mark", country: "Bosnia and Herzegovina", flag: "🇧🇦" },
    ...
    { code: "CDF", name: "Congolese Franc", country: "Democratic Republic of the Congo", flag: "🇨🇩" },
    ...
    { code: "SLE", name: "Sierra Leonean Leone", country: "Sierra Leone", flag: "🇸🇱" },
    ...
    { code: "TMT", name: "Turkmenistan Manat", country: "Turkmenistan", flag: "🇹🇲" },
    ...
    { code: "VES", name: "Venezuelan Bolívar Soberano", country: "Venezuela", flag: "🇻🇪" },
    ...
    { code: "XAF", name: "Central African CFA Franc", country: "CEMAC", flag: "🇨🇫" },
    { code: "XCD", name: "East Caribbean Dollar", country: "Organisation of Eastern Caribbean States", flag: "🇪🇨" },
    { code: "XDR", name: "Special Drawing Rights", country: "International Monetary Fund", flag: "🌐" },
    { code: "XOF", name: "West African CFA franc", country: "CFA Franc BCEAO", flag: "🇨🇫" },
    { code: "XPF", name: "CFP Franc", country: "CFP", flag: "🇨🇵" },
